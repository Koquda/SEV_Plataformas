...
Animation::Animation(string filename, float actorWidth, float actorHeight,
	...
	: actorWidth(actorWidth), actorHeight(actorHeight), fileWidth(fileWidth), fileHeight(fileHeight),
	  updateFrecuence(updateFrecuence), totalFrames(totalFrames), game(game)
{	 
